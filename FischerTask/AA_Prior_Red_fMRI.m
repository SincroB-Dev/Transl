%%%% TRAINING WITH FIXED SENSORY EVIDENCES %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%for block = 1:size(TrialList,2)
    ...
    for trial = 1:length(TrialList{2})
       ...
       [Posbasket_upcorner,Posbasket_downcorner] = posbasket(1100*P,700*P,2.5*TrialList{2}(TrialOrder(trial),1)*P*3,1.4);  
       ...
       [Posbasket_upcorner,Posbasket_downcorner] = posbasket(2000*P,700*P,2.5*TrialList{2}(TrialOrder(trial),2)*P*3,1.4);  
       Screen('PutImage', wPtr, basket, round([Posbasket_upcorner(1) Posbasket_upcorner(2) Posbasket_downcorner(1) Posbasket_downcorner(2)]*P));
